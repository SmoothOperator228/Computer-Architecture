...
SOUNDmsg db 'Beep',0
LOWESTmsg db 'Lowest',0
ABOUTmsg db 'Authors',0
EXITmsg db 'Exit',0
INSTRmsg db "Use up/down arrows to navigate",0
MEmsg db 'Team 7 are Boyko, Karvanskyi, Karpov',0
EXPRmsg db "((a1-a2)+a3)/a4*a5",0
VALUESmsg db "a1 = -2, a2 = 3, a3 = 1, a4 = 2, a5 = 3",0
